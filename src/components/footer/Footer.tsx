    ...
    <div id='footer' className='w-full relative z-0 flex flex-col justify-center bg-neutral-950 py-16'>
      <section className="w-full max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Contact Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-neutral-200">Connect</h3>
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-neutral-400 hover:text-teal-400 transition-colors duration-300 cursor-pointer group">
                <Link href={`https://www.facebook.com/taemmarin.taprab`} target='blank_' className='flex gap-2 items-center justify-center'>
                  <div className="w-10 h-10 rounded-full bg-neutral-800/80 border border-neutral-700 flex items-center justify-center group-hover:border-violet-400 transition-colors">
                    <svg className="w-5 h-5 hover:text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3 text-neutral-400 hover:text-teal-400 transition-colors duration-300 cursor-pointer group">
                <Link href={`https://github.com/KChronos000`} target='blank_' className='flex gap-2 items-center justify-center'>
                  <div className="w-10 h-10 rounded-full bg-neutral-800/80 border border-neutral-700 flex items-center justify-center group-hover:border-violet-400 transition-colors">
                    <svg className="w-5 h-5 hover:text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
