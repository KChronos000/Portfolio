...
const Footer = () => {
  ...
  return (
    <footer id='footer' className='w-full relative z-0 flex flex-col justify-center bg-neutral-950 py-12 md:py-16'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-12">
          ...
          <div className="space-y-4 text-center md:text-start flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-2 pt-1">
              <span className="px-3 py-1 text-xs rounded-full bg-neutral-900 border border-neutral-800 text-neutral-300">HTML</span>
              <span className="px-3 py-1 text-xs rounded-full bg-neutral-900 border border-neutral-800 text-neutral-300">CSS</span>
              <span className="px-3 py-1 text-xs rounded-full bg-neutral-900 border border-neutral-800 text-neutral-300">JavaScript</span>
            </div>
            ...
            <div className="pt-2 w-full flex justify-center md:justify-start">
              <Link 
                href="/admin" 
                className="w-full max-w-[200px] md:w-45 px-6 py-2.5 text-neutral-300 text-sm font-semibold rounded-full border-neutral-800 border bg-neutral-900/50 hover:bg-neutral-900 hover:shadow-lg hover:text-gray-900 dark:text-white hover:border-neutral-700 hover:shadow-violet-900/40 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
              >
          ...
          <div className="space-y-4 text-center md:text-start">
            <h3 className="text-base md:text-lg font-semibold text-neutral-200">Quick Links</h3>
            <ul className="flex flex-wrap justify-center md:flex-col gap-4 md:gap-2">
              {['home', 'skills', 'projects'].map((link) => (
                <li key={link}>
                  <Link href={`#${link}`} className="text-neutral-400 hover:text-violet-400 transition-colors duration-300 text-sm flex items-center justify-center md:justify-start gap-2 group py-1 px-2 md:p-0">
                    <span className="hidden md:inline-block w-0 group-hover:w-4 h-0.5 bg-teal-400 transition-all duration-300"></span>
          ...
          {/* Contact Section */}
          <div className="space-y-4 text-center md:text-start">
            <h3 className="text-base md:text-lg font-semibold text-neutral-200">Connect</h3>
            <div className="flex flex-row md:flex-col justify-center items-center md:items-start gap-4 md:gap-3">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center group-hover:border-violet-400 transition-colors shrink-0">
