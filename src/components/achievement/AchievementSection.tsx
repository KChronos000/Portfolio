        ...
        <div className="relative h-64 md:h-80 overflow-hidden rounded-t-2xl mt-2">
          ...
          {allImages.length > 1 && (
            <>
              <button
                onClick={prevImage}
                className="absolute left-4 top-1/2 -translate-y-1/2 p-2 bg-neutral-950/80 hover:bg-neutral-800 rounded-full transition-colors duration-300 backdrop-blur-sm"
              >
                <ChevronLeft className="w-6 h-6 text-white" />
              </button>
              <button
                onClick={nextImage}
                className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-neutral-950/80 hover:bg-neutral-800 rounded-full transition-colors duration-300 backdrop-blur-sm"
              >
            ...
            <div className="flex flex-wrap gap-4 pt-6 border-t border-neutral-800">
              ...
              {project.githubUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-6 py-3 bg-neutral-800 hover:bg-neutral-700 text-white font-semibold rounded-lg border border-neutral-700 hover:border-gray-500 transition-all duration-300 hover:scale-105"
                >
